  #指定代码的压缩级别
    ...
    #保证实体类不混淆
     -dontwarn com.app.xxnr.bean.**
     -keep class com.app.xxnr.bean.** { *;}

     -dontwarn com.app.xxnr.bean.dbbeans.**
     -keep class com.app.xxnr.bean.dbbeans.** { *;}
    ...
    -keep public class com.app.xxnr.R$*{
